...
public class Servidor {
    ...
    */
    public static HttpServer iniciarServidor() {
        ...
        ResourceConfig configuracao = new ResourceConfig().packages("br.edu.ifba.minasaquaticas");

        return GrizzlyHttpServerFactory.createHttpServer(URI.create(BASE_URI), configuracao);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println();
        System.out.println("Servidor de Minas Aquaticas iniciado.");
